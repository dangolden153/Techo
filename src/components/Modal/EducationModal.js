...
import { addUserEducations } from "../../reducers/actions/profiles";
...
export default function SimpleModal({ setOpen, open }) {
  const [image_url, setImage_url] = useState("https://therootshive.com/cdn/rh1641827358.jpg");
  ...
  const { setEducationData } = useContext(GlobalContext);
...
const handleSave = () => {
    ...
    dispatch(addUserEducations(data));
    setOpen(false);
  };
