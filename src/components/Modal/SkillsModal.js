...
const {skillsData, setSkillsData} = useContext(GlobalContext);
  ...
  const body = (
    <div style={modalStyle} className={classes.paper}>
        ...
        <textarea className={classes.text} value={aboutText} placeholder="Write about your skill set" onChange={handleChange}></textarea>
